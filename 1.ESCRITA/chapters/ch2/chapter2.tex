...
\subsubsection*{Reconstrução do sinal direto}
Alguns sinais digitais transmitidos, como DVB-T em específico, permitem a reconstrução do sinal direto através da desmodulação e re-modulação do sinal direto recebido. Esta técnica permite 
