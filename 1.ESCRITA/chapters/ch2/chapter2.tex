...
$F$: "\textit{noise figure}\footnote{\textit{noise figure} representa a diferença em $dB$ entre o ruído de saída do recetor e a saída de ruído do recetor ideal para o mesmo ganho e largura de banda} efetiva do recetor"\par
