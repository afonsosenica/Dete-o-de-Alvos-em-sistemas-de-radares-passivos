...
\keywords{Radar, Passivo, Deteção, Processamento, Sinal, Iluminador, Oportunidade} % Defina até 6 palavras-chave que descrevam melhor o seu trabalho, e poderá referenciar-las ao longo do seu trabalho com o comando (\keywordnames)

\conkeywords{Radar, Passive, Detection, Processing, Signal, Iluminator, Oportunity} %  Traduza as palavras do resumo e coloque-as aqui(\conkeywordnames)
