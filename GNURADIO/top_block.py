...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.uirange = uirange = 0
        self.samp_rate = samp_rate = 64000

        ##################################################
        # Blocks
        ##################################################
        self._uirange_range = Range(-200, 200, 1, 0, 200)
        ...
        self.fft_vxx_2 = fft.fft_vcc(1024, True, window.blackmanharris(1024), True, 1)
        ...
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, uirange)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 10, 400, -100, 0)
        ...
        self.connect((self.blocks_throttle_1, 0), (self.blocks_add_xx_0, 1))
    ...
    def set_uirange(self, uirange):
        ...
        self.blocks_delay_0.set_dly(self.uirange)
